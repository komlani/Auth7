        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="row">
                    ...
                    <?php if (isset($_SESSION['insertion_succeded'])) : ?>
                    ...
                    <?php if (isset($_SESSION['insertion_failed'])) : ?>
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" value="<?php echo $_SESSION['validated']['title'] ?? '' ?>" class="form-control">
...
unset(
    ...
    $_SESSION['errors'],
    $_SESSION['title'],
    $_SESSION['insertion_succeded'],
    $_SESSION['insertion_failed'],
);
